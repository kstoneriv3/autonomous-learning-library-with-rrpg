...
from all.agents import QMCPG, QMCPGTestAgent
...
class QMCPGClassicControlPreset(Preset):
    """
    ...
    def __init__(self, env, name, device, **hyperparameters):
        ...
        self.qmc_engine = env._env.qmc_engine
    ...
    def agent(self, writer=DummyWriter(), train_steps=float("inf")):
        ...
        return QMCPG(
            ...
            batch_reseeding=self.hyperparameters["batch_reseeding"],
        )

    def test_agent(self):
        features = FeatureNetwork(copy.deepcopy(self.feature_model))
        policy = SoftmaxPolicy(copy.deepcopy(self.policy_model))
        return QMCPGTestAgent(features, policy)

    def parallel_test_agent(self):
        return self.test_agent()


qmcpg = PresetBuilder("qmcpg", default_hyperparameters, QMCPGClassicControlPreset)
