...
class RRPGContinuousPreset(Preset):
    """
    Russian Roulette Policy Gradient (RRPG) Continuous Control preset.
    ...
    def agent(self, writer=DummyWriter(), train_steps=float('inf')):
        ...
        return TimeFeature(RRPG(features, v, policy, discount_factor=self.hyperparameters["discount_factor"], min_batch_size=self.hyperparameters["min_batch_size"]))
    ...
    def test_agent(self):
        ...
        return TimeFeature(RRPGTestAgent(features, policy))

    def parallel_test_agent(self):
        return self.test_agent()


rrpg = PresetBuilder('rrpg', default_hyperparameters, RRPGContinuousPreset)
